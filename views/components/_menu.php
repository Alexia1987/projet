            ...
            <nav class="bg-midnight-blue">
                <ul class="flex flex-col md:flex-row justify-center items-center text-neutral-50 text-lg font-medium p-4">
                    ...
                    <li class="flex items-center w-fit px-3 py-1">    
                        ...
                        <ul class="hidden">
                            <li class="">
                                <a class="" href="">Pistes & karts</a>
                            </li>
                            <li>
                                <a class="" href="">Bar & snacking</a>
                            </li>
                            <li>
                                <a class="" href="">Le concept</a>
                            </li>
                        </ul>
                    </li>         
                    ...
                    <li class="flex items-center w-fit px-3 py-1">                                           
                        ...
                        <ul class="hidden">
                            <li>
                                <a class="" href="">Particuliers</a>
                            </li>
                            <li>
                                <a class="" href="">Groupes et CE</a>
                            </li>
                            <li>
                    ...
                    <li class="flex items-center w-fit px-3 py-1">                                         
                        ...
                        <ul class="hidden">
                            <li>
                                <a class="" href="">Horaires et accès</a>
                            </li>
                            <li>
                                <a class="" href="">Tarifs</a>
                            </li>                            
                        </ul>  
                    </li> 
